...
## Step 0: Quick Setup (RECOMMENDED)

After creating your Supabase project, run both SQL migration files in order:

1. **Storage Policies** - `SUPABASE_STORAGE_POLICY.sql` (for video uploads)
2. **Saved Scans Table** - `SUPABASE_SAVED_SCANS.sql` (for saving graded comics)

Go to SQL Editor and run each file's contents.
